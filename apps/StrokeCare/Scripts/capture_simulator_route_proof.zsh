...
case "${PROOF_ROUTE}" in
    --proof-role-choice|--proof-spatial-prelude|--proof-print-request|--proof-realtime-narration|--proof-spatial-intake|--proof-pressure|--proof-family-pressure-story|--proof-clinician-pressure-story|--proof-clinician-craniotomy|--proof-family-make-space-purpose|--proof-family-surface-reference|--proof-family-arterial-reference|--proof-family-layer-reference|--proof-family-atlas-surface-cue) ;;
    *)
