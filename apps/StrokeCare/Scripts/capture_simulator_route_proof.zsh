...
if [[ "${PROOF_ROUTE}" == --proof-family-neuron-reference ||
      "${PROOF_ROUTE}" == --proof-family-neurovascular-reference ||
      "${PROOF_ROUTE}" == --proof-family-neuron-plain-words ||
      "${PROOF_ROUTE}" == --proof-family-neuron-unsure ||
      "${PROOF_ROUTE}" == --proof-family-point-conversation-reset ]] &&
    (( ${SETTLE_SECONDS} < 15 )); then
    SETTLE_SECONDS=15
fi
