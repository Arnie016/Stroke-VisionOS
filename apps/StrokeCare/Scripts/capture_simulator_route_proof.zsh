...
case "${PROOF_ROUTE}" in
    --proof-spatial-intake|--proof-pressure|--proof-family-pressure-story|--proof-clinician-pressure-story|--proof-clinician-craniotomy|--proof-family-make-space-purpose|--proof-family-surface-reference|--proof-family-arterial-reference) ;;
    *)
