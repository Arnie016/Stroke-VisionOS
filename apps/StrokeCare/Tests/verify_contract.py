...
require("VESSEL STORY" in immersive and "BRAIN ATLAS" in immersive and "let revealAll = experience.anatomyPresentation == .transparent" in scene, "focused specimen rail or transparent lesson-family rendering is missing")
