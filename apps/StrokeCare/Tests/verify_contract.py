...
require("regionPortalActive" in state and "toggleRegionPortal" in state and "LOOK WITHIN" in immersive and "MAGNIFY" in immersive, "role-aware reversible affected-region portal is missing")
