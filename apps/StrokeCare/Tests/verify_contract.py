...
require("let interactionProxy = Entity()" in scene and "CollisionComponent" in scene, "anatomy interaction target must be collision-only, not a visible dark proxy")
