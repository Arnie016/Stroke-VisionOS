...
require("visualBounds(relativeTo: registered)" in scene and "registered.addChild(makePointField" in scene and "* 0.94" in scene and "radius: 0.00165" in scene, "point fields are not derived from registered anatomy bounds at a precise scale")
