...
require("Here, a large stroke causes swelling inside the fixed skull." in state, "family pressure wording is not versioned")
require("Surgery makes room for swelling. It cannot undo the stroke injury." in state, "family procedure-purpose wording is not versioned")
...
require("AVSpeechSynthesizer" in immersive and "narrationEnabled" in state, "audited-copy narrator control is missing")
...
require("SC-AIS-001.2" in clinical_packet and "PENDING CLINICIAN REVIEW" in clinical_packet, "versioned clinical-review boundary is missing")
...
require("SC-AIS-001.2" in clinical_packet and "PENDING CLINICIAN REVIEW" in clinical_packet, "versioned clinical review packet is missing")
