...
require("Schematic teaching radiograph" in xray and "not a patient scan" in xray and "does not display uploaded imaging" in xray, "X-ray teaching boundary is incomplete")
